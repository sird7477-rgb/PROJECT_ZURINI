...
require_text "docs/phase-1-completion.md" "Korea Investment Securities only"
require_text "docs/phase-1.5-large-dummy-rehearsal.md" "Synthetic Large-Dummy Rehearsal"
require_text "docs/phase-1.5-large-dummy-rehearsal.md" "Korea Investment Securities only"
