...
./scripts/test-run-ai-reviews.sh
...
require_file "docs/AI_AUTO_PATCH_MANIFEST.md"
...
require_file "docs/DOMAIN_PACKS.md"
require_file "docs/DOMAIN_PACK_AUTHORING_GUIDE.md"
require_file "docs/INTERVIEW_PLAN_LAYER.md"
require_file "docs/INCIDENT_OPS.md"
...
require_executable_script "scripts/resolve-feedback.sh"
...
require_text "docs/AI_AUTO_PATCH_MANIFEST.md" "AI_AUTO Patch Manifest"
...
require_text "docs/DOMAIN_PACKS.md" "Domain Packs"
require_text "docs/DOMAIN_PACK_AUTHORING_GUIDE.md" "Domain Pack Authoring Guide"
require_text "docs/INTERVIEW_PLAN_LAYER.md" "Interview And Plan Layer"
require_text "docs/INCIDENT_OPS.md" "Incident Ops"
