...
- Real historical-data collection/validation starts after this dummy-data target
  and will use Korea Investment Securities only unless the owner explicitly
